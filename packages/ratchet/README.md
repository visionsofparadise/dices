...
**@xkore/ratchet** provides end-to-end encrypted sessions between peers using a bounded triple ratchet protocol combining:
...
```bash
npm install @xkore/ratchet
```

## Quick Start

```typescript
import { Session, Keys, RatchetKeysItem } from '@xkore/ratchet';
